    ...
    <div class="row">
        <div class="col-md-6 col">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="judul" id="judul" placeholder="Judul" class="form-control" type="text" required>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="tanggalMulai" id="tanggalMulai" placeholder="Tanggal Mulai" class="form-control" type="date" required>
                    <span class="help-block"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="tanggalSelesai" id="tanggalSelesai" placeholder="Tanggal Selesai" class="form-control" type="date" required>
                    <span class="help-block"></span>
                </div>
            </div>
