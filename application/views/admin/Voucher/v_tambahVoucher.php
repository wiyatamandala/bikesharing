    ...
    <div class="row">
        <div class="col-md-6 col">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input name="nama" id="nama" placeholder="Nama Voucher" class="form-control" type="text" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input name="kategori" id="kategori" placeholder="Kategori" class="form-control" type="text" required>
                    <span class="help-block"></span>
                </div>
            </div>
